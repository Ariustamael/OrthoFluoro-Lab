import { Group, Material, MathUtils, Mesh, type Object3D } from "three";
...
export interface HipAnatomyViewportSceneOptions {
  /**
   * Viewports clone materials so they can style anatomy independently. Projection
   * renderers use override materials and keep provider materials shared/read-only.
   */
...
export function createHipAnatomyViewportScene(
  ...
  options: HipAnatomyViewportSceneOptions = {},
